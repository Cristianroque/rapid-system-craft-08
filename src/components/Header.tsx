        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Button onClick={handleContactClick} className="gradient-primary text-white">
                Contato
              </Button>
            </nav>
          ...
          {isMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 space-y-4">
              ...
              <button onClick={handlePortfolioClick} className="block text-foreground hover:text-primary transition-colors">
                Portfólio
              </button>
